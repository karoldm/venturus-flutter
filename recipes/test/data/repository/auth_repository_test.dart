  ...
  group('AuthRepository', () {
    ...
    group('signUp', () {
      ...
      test('deve retornar erro quando e-mail já existe', () async {
        ...
        expect(message, equals('E-mail já cadastrado'));
      });
      ...
      test('deve retornar erro quando username já existe', () async {
        ...
        expect(message, equals('Username já existe'));
      });
      ...
      test(
        ...
        () async {
          ...
          expect(message, equals('Erro ao fazer cadastro'));
        },
      );
      ...
      test('deve retornar erro inesperado no signUp', () async {
        ...
        expect(message, equals('Erro inesperado'));
      });
    });
    ...
    group('signOut', () {
      ...
      test('deve retornar erro quando logout falha', () async {
        ...
        expect(message, equals('Erro ao fazer logout'));
      });
    });
  });
}
